...
@Deprecated(
    message = "Use UserIconBottomSheet instead",
    replaceWith = ReplaceWith("UserIconBottomSheet(modifier, size, testTag)")
)
@Composable
fun UserIconButtonSheet(
    ...
    size: Dp = 48.dp,
    testTag: String = ""
) = UserIconBottomSheet(modifier, size, testTag)

@Composable
@Preview
private fun UserIconBottomSheetPreview() {
    ToteatTheme {
        UserIconBottomSheet()
    }
}